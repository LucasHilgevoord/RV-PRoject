        ...
        : MonoBehaviour
    {
        ...
        internal GameObject VisualizerParent
        {
            get
            {
                ...
                {
                    CreateSkeletonModel(Quaternion.identity);
                }
        ...
        void Update()
        {
            ...
            {
                if (!f) f = GameObject.Find("SpineMid").transform;

                Vector3 playerPos = player.transform.position - root.LocalPosition + Vector3.up * 0.5f;
                
                //playerPos.z = playerPos.z - 1.4f;
                //playerPos.y = playerPos.y + .57f;
                //playerPos.x = player.transform.position.x;
                UpdateBone(root, playerPos, Quaternion.identity);
            }
        }
        ...
        /// </summary>
        private void CreateSkeletonModel(Quaternion startRotation)
        {
            if (this.visualizerParent != null)
            {
            ...
            this.visualizerParent = player;
            //this.visualizerParent.transform.localScale += new Vector3(-2F, 0, 0);
            this.visualizerParent.transform.position = player.transform.position;
